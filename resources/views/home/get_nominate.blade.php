...
@endif
                        <div class="forms">
                            <h4>Registration For Nomination</h4>
                            <form  action="{{route('save_nomination')}}" method="post"  enctype="multipart/form-data">
                              {{csrf_field()}}
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="address" class="form-control" id="text" placeholder="address">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" name="education" class="form-control" id="email" placeholder="education">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        <div class="form-group">
                                           <textarea class="form-control" name="about" cols="100" rows="80" placeholder="About yor self"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-lg-12">
                                        <div class="form-group">
                                            <select name="position" class="form-control">
                                                ...
                                                <option value="" disabled selected>Select Nominate Position</option>
        ...
        <div class="register-now-countdown mb-100 wow fadeInUp" data-wow-delay="500ms">
            <h3>Nomination Registration have Time For You..</h3>
